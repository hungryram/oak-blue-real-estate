...
const ListingHeader = ({ status, price, address, city, state, zipCode }) => {
    return(
        <div className="flex flex-col lg:flex-row lg:items-center p-4 lg:p-8">
            ...
            <span className="text-3xl text-primary font-light mb-10">{price}</span>
                ...
                <div className="flex flex-row items-center my-4 lg:my-0">
                    <span className="mr-2 text-lg text-secondary">Status:</span>
                    <span className="text-lg text-secondary font-bold text-primary">{status}</span>
                </div>
            </div>
