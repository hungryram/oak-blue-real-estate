...
const TeamMember = ({ data }) => {
    ...
    return(
        <>
          ...
          <div className="flex flex-col lg:flex-row lg:items center max-w-screen-2xl mx-auto p-4 lg:p-8">
            <TeamCard
            ...
            <div className="flex flex-col lg:w-2/3 px-2 py-8 lg:p-0 lg:ml-8">
              <h2 className="text-primary uppercase font-bold">{team.frontmatter.pageHeader}</h2>
